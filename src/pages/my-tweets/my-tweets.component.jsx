...
import { deleteTweet, fetchMyTweets, likeTweet, updateTweet } from './my-tweets.helper';
                        ...
                        <div style={{ width: "100%", justifyContent: "flex-start", display: "inline-flex", flexDirection: "column", alignItems: "flex-start" }}>
                            <div style={{ display: "inline-flex", justifyContent: "space-between", width: "100%" }}>
                                ...
                                <div style={{ marginBottom: 10 }}>
                                    <span className={"ml-4"} height={20} width={20} onClick={onEditClick} ><EditRoundedIcon /></span>
                                    <span className={"ml-4"} height={20} width={20} onClick={onDeleteClick} >{<DeleteForeverRoundedIcon />}</span>
                                </div>
